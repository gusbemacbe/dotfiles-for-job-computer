...
export OSH=/home/gusbemacbe/.oh-my-bash
...
export NPM_CONFIG_PREFIX="/home/gusbemacbe/.nvm/versions/node/v16.8.0"
...
code_java()
{
	code-insiders ~/Workspaces/Linux/Java.code-workspace "$@"
}

code_py()
{
	code-insiders ~/Workspaces/Linux/Python.code-workspace "$@"
}
